        ...
        <div class="panel panel-default">
            ...
            <div class="panel-heading panal-header">
                <div class="panal-header-title">
                    <h1 class="pull-left"> View Income</h1>
            ...
            <div class="panel-body">
                ...
                <h3 style="margin-top: -10px;" class="text-center hide">Income Information</h3><br/>
                ...
                <div class="col-md-12">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tr>
                            <th>Date</th>
                            <td>
                                <p><?php echo $incomeInfo[0]->date; ?></p>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <p><?php echo $incomeInfo[0]->income_field; ?></p>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <th>Description </th>
                            <td>
                                <p><?php echo $incomeInfo[0]->description; ?></p>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <th>Income By</th>
                            <td>
                                <p><?php echo $incomeInfo[0]->income_by; ?></p>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <th>Amount</th>
                            <td>
                                <p><?php echo $incomeInfo[0]->amount.' TK'; ?></p>
                            </td>
                        </tr>
