            ...
            <div class="panel-body no-padding">
                ...
                <div class="col-md-9">                                
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <input type="number" name="amount" class="form-control" placeholder="BDT" min="0">
                            </div>
                        </div>
                        
                        <div class="form-group">
                            <label for="" class="col-md-3 control-label">By </label>
                            <div class="col-md-7">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <div class="btn-group pull-right">
                                    <input class="btn btn-primary" type="submit" name="add_income" value="Save">
                                </div>
                            </div>
                        </div>
                </div>
