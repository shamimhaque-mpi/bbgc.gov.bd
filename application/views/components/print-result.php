            ...
            <div class="panel panel-default" ng-init="active=true">
                <div class="panel-heading">
                    <div class="panal-header-title">
                        <h1 class="pull-left">Result Sheet</h1>
                ...
                <div class="panel-body">
                    ...
                    <p class="text-center hide">
                        ...
                        Exam
                        : <?php $ex_info = $this->action->read("exam", array("exam_id" => $this->input->post("exam_id")));
                        if ($ex_info != NULL) {
                        ...
                        */
                        foreach($allMarks as $key => $val){
            				...
            				*/
                            ...
                            if ($info) {
                                $rGPA    = ($subjectStatus == 'all_exists') ? $gpa : '0.00';
                                $rLETTER = ($subjectStatus == 'all_exists') ? letter_grade($gpa) : 'F';

                                if (!empty($_POST['status'])) {
                                    if ($_POST['status'] == 'pass' && $rLETTER !== 'F') {  $counter++; ?>
                                        <tr>
                                            <td class="text-center"><?php echo $counter; ?></td>
                                            <td><?php echo ($info) ? $info[0]->name : ''; ?></td>
                                            <td class="text-center"><?php echo $row->roll; ?></td>
                                            <td class="text-center"> <?php echo $total; ?> </td>
                                            <td class="text-center"><?php echo $rGPA; ?></td>
                                            <td class="text-center"><?php echo $rLETTER; ?></td>
                                    ...
                                    <?php } elseif ($_POST['status'] == 'fail' && $rLETTER == 'F') {  $counter++; ?>
                                        <tr>
                                            <td class="text-center"><?php echo $counter; ?></td>
                                            <td><?php echo ($info) ? $info[0]->name : ''; ?></td>
                                            <td class="text-center"><?php echo $row->roll; ?></td>
                    ...
                    <div class="pull-right hide"
                         style="width: 200px; margin: 35px 0px 0px; text-align: center; border-top: 1px solid #bfbaba;">
