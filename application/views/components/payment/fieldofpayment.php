    ...
    ?>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body no-padding">
                ...
                <input type="hidden" name="old_field_name" value="<?php echo $info->field_name; ?>">
                <?php } ?>
                ...
                <div class="col-md-9">
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <input type="text" name="field_name" value="<?php echo (!empty($info) ? $info->field_name : ''); ?>" class="form-control" autocomplete="off">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <div class="btn-group pull-right">
                                <input class="btn btn-primary" type="submit" name="submit" value="<?php echo (!empty($info) ? 'Update' : 'Save'); ?>">
                            </div>
                        </div>
                    </div>
            ...
            <table class="table table-bordered" ng-cloak>
                ...
                <tr dir-paginate="row in fields|filter:search|itemsPerPage:perPage|orderBy:sortField:reverse">
                    ...
                    <td class="none text-center" >
                        <a title="Edit" class="btn btn-warning" href="<?php echo site_url('payment/payment?field_id={{row.id}}'); ?>" ><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
