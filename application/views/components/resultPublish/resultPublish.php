    ...
    <div class="row">
        ...
        <div class="panel panel-default" ng-init="active=true">
        	...
        	<div class="panel-body">
			   ...
			   <input type="hidden" name="exam_id" value="<?php echo $this->input->post('exam_id'); ?>">
				 <input type="hidden" name="class" value="<?php echo $this->input->post('class'); ?>">
				 <input type="hidden" name="year" value="<?php echo $this->input->post('year'); ?>">
				 <input type="hidden" name="date" value="<?php echo $this->input->post('date'); ?>">
				 <input type="hidden" name="section" value="<?php echo $this->input->post('section'); ?>">
				...
				*/
                ...
                if($this->input->post('exam_id') == "1581241346"){
                  foreach($allPoints as $value){
                   ...
                   foreach($passPoints as $value){
                    ...
                    <tr>
                       <td  width="80px"><input type="text" class="text-center form-control" readonly value="<?php echo $counter;?>"></td>
											 <td>
													<input type="hidden" class="form-control" readonly value="<?php echo ($info) ? $info[0]->group : ""; ?>" name="group[]">
													<input type="text" class="form-control" readonly value="<?php echo ($info) ? $info[0]->name : ""; ?>" name="name[]">
											 </td>

											  <td>
                            <input type="text" class="text-center form-control" readonly value="<?php echo $row->roll; ?>" name="roll[]">
                        </td>

												 <td>
                            <input type="text" class="text-center form-control" readonly value="<?php echo $total; ?>" name="total[]">
                        </td>

												<td><input type="text" class="text-center form-control" readonly value="<?php printf("%.2f",$gpa); ?>"  name="gpa[]"></td>
                        <td><input type="text" class="text-center form-control" readonly value="<?php echo letter_grade($gpa); ?>"></td>
