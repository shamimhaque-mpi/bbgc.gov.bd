				...
				<div class="row">
					...
					<div class="col-md-8">
					      ...
					      <div class="form-group ">
							...
							<!--div class="form-group ">
								<label class="col-md-4 control-label">First Name <span class="req">*</span></label>
								<div class="col-md-8">
									<input type="text" name="first_name" value="<?php echo $student[0]->first_name;?>" class="form-control" required>
								</div>
							</div>
							
							<div class="form-group ">
								<label class="col-md-4 control-label">Last Name <span class="req">*</span></label>
								<div class="col-md-8">
									<input type="text" name="last_name" value="<?php echo $student[0]->last_name;?>" class="form-control" required>
								</div>
							</div-->
