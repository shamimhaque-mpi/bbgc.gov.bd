<style>
    ...
    @media print{
        nav, header, aside, form, .form-element{ display: none;}
		.income-table h3{ display: block;text-align: center;font-weight: bold;}
		.income-table button{ display: none;}
		table{ width: 100%;}
		table, tr, th, td{ border: 1px solid #000;border-collapse: collapse;}
		table tr th,table tr td{ text-align: left !important;padding: 0 5px;}
		table#cost-table tr th:nth-child(1),table#cost-table tr td:nth-child(1){ text-align: center !important;}
		table#income-table tr th:nth-child(1),table#income-table tr td:nth-child(1){ text-align: center !important;}
	}
</style>
