                ...
                <div class="table_responsive">
                    ...
                    <table class="table table-bordered">
                        <tr>
                            <th>তারিখ</th>
                            <?php
                                $income_field = read('income_field', [], 'id asc');
                                if($income_field!=null){
                                    foreach($income_field as $key => $value){
                                // ----------------------------------------------
                            ?>
                                <th><?php echo $value->field_income; ?></th>
                            <?php }} ?>
                            <th>মোট</th>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php
                                    $income_field_id = isset($income_value->income_field) ? $income_value->income_field : '';
                                    $sum = $this->action->read_sum('income', "amount", ['date'=>$income_value->date, 'income_field'=>$income_value2->code, 'trash'=>0]);
                        ...
                        <?php }} ?>
                            ...
                            <th>মোট</th>
                            <?php
                                $income_field_for_total = read('income_field', [], 'id asc');
                            ...
                            ?>
                                <td>
                                    <?php
                                        ...
                                        $vertical_total = $this->action->read_sum('income','amount', $where);
