<div class="container-fluid">
    ...
    <?php 
     ...
     //echo "<pre>"; print_r($profile_info); echo "</pre>"; ?>
        <div class="panel panel-default">
            ...
            <div class="panel-body no-padding">
                    ...
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane active" id="profile">
                            <div class="col-xs-12 profile-title no-padding">
                                ...
                                <div class="col-xs-6">
                                    <a class="pull-right" data-toggle="modal" data-target=".bs-example-modal-lg" style="min-width: 115px;padding:0 5px;" href="#"><i class="fa fa-pencil"></i>&nbsp; Edit Password</a>
                                </div>
                            </div>
                ...
                echo form_open_multipart('settings/editProfile/passUpdate?id='. $profile_info[0]->id, $attribute);
                ?>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-10">
                                                            <div class="pull-right">
                                                                <input class="btn btn-primary" name="updatePass" type="submit" value="Save">
                                                            </div>
                                                        </div>
                                                    </div>
<?php echo form_close();?>
