        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <!--div class="view-profile" style="margin-bottom: 20px; height: 100px;">
                    ...
                    <div class="col-xs-8">
                        <div class="institute">
                            <h2 class="text-center title" style="margin-top: 10; font-weight: bold;">College</h2>
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td class="none text-center " style="width: 160px;">
                            ...
                            <a title="view" class="btn btn-info" href="<?php echo site_url('cost/cost/profile/'.$value->id);?>" ><i class="fa fa-eye" aria-hidden="true"></i></a>
