                        ...
                        <div class="col-md-7">
                            <select name="cost_field" class="form-control">
                              <?php foreach ($cost_fields as $key => $value) {?>
                                  <option <?php if($cost[0]->cost_field == str_replace(" ","_",$value->cost_field)){ echo "selected"; }?> value="<?php echo str_replace(" ","_",$value->cost_field); ?>"><?php echo $value->cost_field; ?></option>
                              <?php } ?>                             
                             </select> 
                        </div>
                    </div>
