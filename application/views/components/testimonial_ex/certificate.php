...
<html lang="en">
    ...
    <body>
        ...
        <div class="print-area">
            ...
            <div class="info">
                <h5 class="slno" style="margin: 10px 0;font-style: italic;font-weight: 600; font-size: 16px;">Serial no. <?php $si = 180000; echo ($si + $student[0]->id); ?></h5>
            </div>
            <p style="margin-top: 5%;"> &nbsp; &nbsp; &nbsp; &nbsp; This is to certify that <?php echo strtoupper($student[0]->name); ?>, Father’s Name- <?php echo strtoupper($student[0]->father_name); ?>, Mother’s Name- <?php echo strtoupper($student[0]->mother_name); ?>, academic year <?php echo $student[0]->session; ?>, was a student of Higher Secondary <?php echo $student[0]->group; ?> Group. He/She took part in the Higher Secondary Certificate Examination of Dhaka Board <?php echo $student[0]->year;?> as a Regular/ Irregular student from this college. He/She Obtained GPA <?php echo $student[0]->gpa;?> in the <?php echo $student[0]->group; ?> Group. His/Her Roll was Muktagachha No- <?php echo $student[0]->roll;?>, Reg: No <?php echo $student[0]->reg_id;?>, Session <?php echo $student[0]->session;?> .</p></br> <p>
