        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
               ...
               <!--<img class="img-responsive print-banner hide" src="<?php //echo site_url('public/img/banner.jpg'); ?>"> -->
                ...
                <span class="hide print-time text-center">খরচের খাত</span><br>
                ...
                <div ng-cloak class="row none" style="margin-bottom:15px;">
                 <div class="col-md-4">
                     <input type="text" ng-model="search" placeholder="Search With Name..." class="form-control">
                </div>
