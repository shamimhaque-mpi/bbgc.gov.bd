            ...
            <div class="panel-body no-padding">
                ...
                <div class="col-md-9">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                           <textarea name="description" class="form-control" cols="30" rows="4" placeholder="Write Discription...."></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <input type="text" name="spend_by" class="form-control" placeholder="Maximum 100 Characters......">
                        </div>
                    </div>
