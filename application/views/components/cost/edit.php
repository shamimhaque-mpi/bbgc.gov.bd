            ...
            <div class="panel-body no-padding">
                ...
                <div class="col-md-9">                                
                        ...
                        <div class="col-md-7">
                            <select name="cost_field" class="form-control">
                              <?php foreach ($cost_fields as $key => $value) {?>
                                  <option <?php if($cost[0]->cost_field == $value->code){ echo "selected"; }?> value="<?php echo $value->code; ?>"><?php echo $value->cost_field; ?></option>
                              <?php } ?>                             
                             </select> 
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                               <textarea name="description" class="form-control" cols="30" rows="4" placeholder="Write Your Description...."><?php echo $cost[0]->description; ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-md-3 control-label">Amount </label>
                            <div class="col-md-7">
                                <input type="text" name="amount" class="form-control" value="<?php echo $cost[0]->amount; ?>" placeholder="Amount....">
                            </div>
                        </div>
                        
                        <div class="form-group">
                            <label for="" class="col-md-3 control-label">Cost By </label>
                            <div class="col-md-7">
                                <input type="text" name="spend_by" class="form-control" value="<?php echo $cost[0]->spend_by; ?>" placeholder="Maximum 100 Characters......">
                                                            </div>
                        </div>
