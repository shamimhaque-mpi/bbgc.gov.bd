    ...
    <div class="row">
		...
		<div class="col-md-3">
            ...
            <div class="col-md-12 chart">
                <div class="col-md-12">
                    <div class="panel panel-default">
						<div class="panel-heading"><b>Subject Wise Student Admission</b></div>

						<div class="panel-body">
							
							<table class="table">
								<tr class="success">
									<td style="border-top: none;">CIVICS & GOOD GOVERNANCE</td>
									<td style="border-top: none;">
									  <?= (!empty($civics_total) ? $civics_total : 0) ?>   Students
									 </td>
								</tr>
								<tr class="active">
									<td>
									...
									<td>
									    <?= (!empty($social_total) ? $social_total : 0) ?>   Students
									</td>
								</tr>
								<tr class="info">
									<td>History</td>
									<td><?= (!empty($history_total) ? $history_total : 0) ?>   Students</td>
								</tr>
								<tr>
									<td>Geography</td>
									<td><?= (!empty($geography_total) ? $geography_total : 0) ?> Students</td>
								</tr>
								<tr class="danger">
									<td>ECONOMICS</td>
									<td><?= (!empty($economics_total) ? $economics_total : 0) ?> Students</td>
								</tr>
								<tr class="success">
									<td>LOGIC</td>
									<td><?= (!empty($logic_total) ? $logic_total : 0) ?> Students</td>
								</tr>
								<tr class="info">
									<td>SOCIOLOGY</td>
									<td><?= (!empty($sociology_total) ? $sociology_total : 0) ?> Students</td>
								</tr>
								<tr>
									<td>ISLAMIC HISTORY AND CULTURE</td>
									<td><?= (!empty($islam_toatal) ? $islam_toatal : 0) ?> Students</td>
								</tr>
								
								<tr class="danger">
									<td>Agriculture Education</td>
									<td><?= (!empty($agriculture) ? $agriculture : 0) ?> Students</td>
								</tr>
								<tr class="success">
									<td>Psychology</td>
									<td><?= (!empty($psychology) ? $psychology : 0) ?> Students</td>
								</tr>
								<tr class="info">
									<td>Islamic Studies</td>
									<td><?= (!empty($islamic_studies) ? $islamic_studies : 0) ?> Students</td>
								</tr>
							</table>
						</div>
						...
						<div class="panel-body">
							...
							<table class="table">
								<tr>
									...
									<td style="border-top: none;"><?php echo $current_visitor; ?> Students</td>
								</tr>
								<tr>
									<td>Today Visitor</td>
									<td><?php echo $todays_visitor; ?> Students</td>
								</tr>
								<tr>
									<td>Last Month Visitors</td>
									<td><?php echo $last_month_visitor; ?> Students</td>
								</tr>
								<tr>
									<td>Total Visitor</td>
									<td><?php echo $total_visitor; ?> Students</td>
								</tr>
							</table>
						</div>
